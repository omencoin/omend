...
ifeq (cleveldb,$(findstring cleveldb,$(OMENCHAIN_BUILD_OPTIONS)))
  build_tags += gcc
else ifeq (rocksdb,$(findstring rocksdb,$(OMENCHAIN_BUILD_OPTIONS)))
  build_tags += gcc
endif
...
ifeq (,$(findstring nostrip,$(OMENCHAIN_BUILD_OPTIONS)))
  ldflags += -w -s
endif
