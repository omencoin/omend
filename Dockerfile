...
FROM golang:${GO_VERSION}-alpine3.20 AS omen-builder
WORKDIR /src/app/
...
ARG IMG_TAG
COPY --from=omen-builder /src/app/build/omenchaind /usr/local/bin/
EXPOSE 26656 26657 1317 9090
USER nonroot

ENTRYPOINT ["omenchaind", "start"]